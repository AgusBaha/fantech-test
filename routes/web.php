...
Route::middleware(['auth', 'role:sales, superuser'])->group(function () {
...
Route::middleware(['auth', 'role:purchase, superuser'])->group(function () {
...
Route::middleware(['auth', 'role:manager'])->group(function () {
    Route::controller(ManagerController::class)->group(function () {
        Route::get('/manager/sales', 'indexSales')->name('manager.sales.index');
        Route::get('/manager/sales/{id}/print', 'printSalesManager')->name('manager.sales.print');

        Route::get('/manager/purchase', 'indexPurchase')->name('manager.purchase.index');
        Route::get('/manager/pruchase/{id}/print', 'printPruchaseManager')->name('manager.pruchase.print');
    });
});
